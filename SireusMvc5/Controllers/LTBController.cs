...
namespace SireusMvc5.Controllers
{
    public class LtbController : Controller
    {
        ...
        public FileContentResult Chart(string id)
        {
        ...
        public ActionResult NoRepair(string id)
        {
            var arg = id.Split('/');
        ...
        public ActionResult LtbDate(string id)
        {
            var arg = id.Split('/');
        ...
        public ActionResult EosDate(string id)
        {
            var arg = id.Split('/');
                ...
                switch (yearCnt)
                {
                    case 1:
                        ...
                        if (nbrOfServiceYears != 0)
                        {
                            ...
                            ViewData["IB1Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS1"] = string.Empty;
                        ViewData["FR1"] = string.Empty;
                        ViewData["RL1"] = string.Empty;
                        ViewData["RS1Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR1Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL1Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 2:
                        ...
                        if (nbrOfServiceYears != 1)
                        {
                            ...
                            ViewData["IB2Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS2"] = string.Empty;
                        ViewData["FR2"] = string.Empty;
                        ViewData["RL2"] = string.Empty;
                        ViewData["RS2Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR2Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL2Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 3:
                        ...
                        if (nbrOfServiceYears != 2)
                        {
                            ...
                            ViewData["IB3Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS3"] = string.Empty;
                        ViewData["FR3"] = string.Empty;
                        ViewData["RL3"] = string.Empty;
                        ViewData["RS3Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR3Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL3Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 4:
                        ...
                        if (nbrOfServiceYears != 3)
                        {
                            ...
                            ViewData["IB4Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS4"] = string.Empty;
                        ViewData["FR4"] = string.Empty;
                        ViewData["RL4"] = string.Empty;
                        ViewData["RS4Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR4Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL4Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 5:
                        ...
                        if (nbrOfServiceYears != 4)
                        {
                            ...
                            ViewData["IB5Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS5"] = string.Empty;
                        ViewData["FR5"] = string.Empty;
                        ViewData["RL5"] = string.Empty;
                        ViewData["RS5Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR5Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL5Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 6:
                        ...
                        if (nbrOfServiceYears != 5)
                        {
                            ...
                            ViewData["IB6Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS6"] = string.Empty;
                        ViewData["FR6"] = string.Empty;
                        ViewData["RL6"] = string.Empty;
                        ViewData["RS6Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR6Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL6Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 7:
                        ...
                        if (nbrOfServiceYears != 6)
                        {
                            ...
                            ViewData["IB7Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS7"] = string.Empty;
                        ViewData["FR7"] = string.Empty;
                        ViewData["RL7"] = string.Empty;
                        ViewData["RS7Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR7Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL7Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 8:
                        ...
                        if (nbrOfServiceYears != 7)
                        {
                            ...
                            ViewData["IB8Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS8"] = string.Empty;
                        ViewData["FR8"] = string.Empty;
                        ViewData["RL8"] = string.Empty;
                        ViewData["RS8Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR8Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL8Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 9:
                        ...
                        if (nbrOfServiceYears != 8)
                        {
                            ...
                            ViewData["IB9Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
                        ViewData["RS9"] = string.Empty;
                        ViewData["FR9"] = string.Empty;
                        ViewData["RL9"] = string.Empty;
                        ViewData["RS9Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["FR9Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        ViewData["RL9Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                    ...
                    case 10:
                        ...
                        if (nbrOfServiceYears != 9)
                        {
                            ...
                            ViewData["IB10Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                        }
            ...
            while (cnt <= nbrOfServiceYears)
            {
                switch (cnt)
                {
                    case 0:
                        if (!repairAvailable)
                        {
                            ViewData["RL0Disabled"] = new MvcHtmlString(string.Format("disabled={0}", "\"disabled\""));
                            ViewData["RL0"] = "100";
                        }
                        else
                        {
                ...
                switch (yearCnt)
                {
                    case 0:
                        ...
                        if (Convert.ToInt32(ViewData["IB0"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR0"].ToString()) < 1E-07 |
                            Convert.ToDouble(ViewData["FR0"].ToString()) > 100 |
                    ...
                    case 1:
                        ...
                        if (Convert.ToInt32(ViewData["IB1"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR1"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR1"].ToString()) > 100 |
                    ...
                    case 2:
                        ...
                        if (Convert.ToInt32(ViewData["IB2"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR2"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR2"].ToString()) > 100 |
                    ...
                    case 3:
                        ...
                        if (Convert.ToInt32(ViewData["IB3"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR3"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR3"].ToString()) > 100 |
                    ...
                    case 4:
                        ...
                        if (Convert.ToInt32(ViewData["IB4"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR4"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR4"].ToString()) > 100 |
                    ...
                    case 5:
                        ...
                        if (Convert.ToInt32(ViewData["IB5"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR5"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR5"].ToString()) > 100 |
                    ...
                    case 6:
                        ...
                        if (Convert.ToInt32(ViewData["IB6"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR6"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR6"].ToString()) > 100 |
                    ...
                    case 7:
                        ...
                        if (Convert.ToInt32(ViewData["IB7"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR7"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR7"].ToString()) > 100 |
                    ...
                    case 8:
                        ...
                        if (Convert.ToInt32(ViewData["IB8"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR8"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR8"].ToString()) > 100 |
                    ...
                    case 9:
                        ...
                        if (Convert.ToInt32(ViewData["IB9"].ToString()) > 999999 |
                            ...
                            Convert.ToDouble(ViewData["FR9"].ToString()) < 1E-06 |
                            Convert.ToDouble(ViewData["FR9"].ToString()) > 100 |
            ...
            string RL9)
        {
            ...
            if (!_repairSelected)
            {
                ...
                ViewData["NoRepairChecked"] = new MvcHtmlString(string.Format("checked={0}", "\"checked\""));
            }
            else
            {
                ViewData["Repair"] = "";
                ViewData["NoRepair"] = "javascript:SetNoRepair();";
                ViewData["RepairChecked"] = new MvcHtmlString(string.Format("checked={0}", "\"checked\""));
        ...
        private void EosChanged(out bool alert)
        {
            ...
            if (DateTimeUtil.DateDiff(DateTimeUtil.DateInterval.Day, startDate, endDate) > LtbCommon.MaxServiceDays)
            {
                ...
                ltmp = endDate.AddDays(-LtbCommon.MaxServiceDays).ToString(); //(ci);
                ViewData["InfoText"] = "Fel: Serviceperioden får ej vara längre än 10 år. Vänligen ändra EoS eller LTB";
                alert = true;
            }
            else if (
                    ...
                    Convert.ToDateTime(ViewData["EOSDate"].ToString(), ci)) < LtbCommon.MinLeadDays)
            {
                ...
                ltmp = endDate.AddDays(-LtbCommon.MinLeadDays).ToString();
                ViewData["InfoText"] =
                    "Fel: Serviceperioden får ej vara längre än 10 år. Vänligen ändra EoS eller LTB";
                alert = true;
            }
